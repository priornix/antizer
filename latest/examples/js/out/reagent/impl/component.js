...
if((i < len)){
var k = (ks[i]);
var G__14843 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__14844 = (i + (1));
m = G__14843;
i = G__14844;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__14848 = c;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__14852 = c;
var G__14852__$1 = (((G__14852 == null))?null:G__14852.prototype);
if((G__14852__$1 == null)){
return null;
} else {
return (G__14852__$1["render"]);
}
})()));
});
...
var G__14856 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__14856) : reagent.impl.component.as_element.call(null,G__14856));
};
...
while (G__14859__i < G__14859__a.length) {G__14859__a[G__14859__i] = arguments[G__14859__i + 0]; ++G__14859__i;}
  args = new cljs.core.IndexedSeq(G__14859__a,0);
} 
...
return G__14858__delegate(args);
});
...
var _STAR_current_component_STAR_14863 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14863;
}});
...
var G__14871 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__14871) {
...
return ((function (G__14871){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__14874 = reagent.impl.component.state_atom(c);
var G__14875 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__14874,G__14875) : cljs.core.reset_BANG_.call(null,G__14874,G__14875));
});
;})(G__14871))
...
var c = this;
var G__14877_14879 = (c["cljsRatom"]);
if((G__14877_14879 == null)){
} else {
reagent.ratom.dispose_BANG_(G__14877_14879);
}
...
var renders_14882 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_14883 = cljs.core.first(cljs.core.vals(renders_14882));
if((cljs.core.count(renders_14882) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_14882))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_14883)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_14883], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}
...
var name__$1 = (function (){var G__14881 = name;
switch (G__14881) {
case "":
...
var elem = (function (){var G__14892 = (function (){var or__6409__auto__ = (function (){var G__14894 = c;
if((G__14894 == null)){
return null;
} else {
return (G__14894["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
...
return (G__14892["_currentElement"]);
}
})();
var name = (function (){var G__14895 = elem;
var G__14895__$1 = (((G__14895 == null))?null:(G__14895["type"]));
if((G__14895__$1 == null)){
return null;
} else {
return (G__14895__$1["displayName"]);
}
})();
var path = (function (){var G__14896 = elem;
var G__14896__$1 = (((G__14896 == null))?null:(G__14896["_owner"]));
var G__14896__$2 = (((G__14896__$1 == null))?null:reagent$impl$component$component_path(G__14896__$1));
if((G__14896__$2 == null)){
return null;
} else {
return [cljs.core.str(G__14896__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__14898 = c;
var G__14898__$1 = (((G__14898 == null))?null:G__14898.constructor);
if((G__14898__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__14898__$1);
}
}
})();
