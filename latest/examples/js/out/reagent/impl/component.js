...
if((i < len)){
var k = (ks[i]);
var G__17878 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__17879 = (i + (1));
m = G__17878;
i = G__17879;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__17880 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__17880) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__17880));
})());
} else {
var v = temp__5459__auto__;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__17882 = c;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__17884 = c;
...
return (function() { 
var G__17888__delegate = function (args){
var G__17886 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__17886) : reagent.impl.component.as_element.call(null,G__17886));
};
...
while (G__17889__i < G__17889__a.length) {G__17889__a[G__17889__i] = arguments[G__17889__i + 0]; ++G__17889__i;}
  args = new cljs.core.IndexedSeq(G__17889__a,0,null);
} 
return G__17888__delegate.call(this,args);};
...
return G__17888__delegate(args);
});
...
var _STAR_current_component_STAR_17892 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_17892;
}});
...
var G__17893 = key;
var G__17893__$1 = (((G__17893 instanceof cljs.core.Keyword))?G__17893.fqn:null);
switch (G__17893__$1) {
...
return ((function (G__17893,G__17893__$1){
...
var or__8522__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__8522__auto__){
...
if((f == null)){
var or__8522__auto____$1 = noargv;
if(or__8522__auto____$1){
...
var c = this;
var G__17898_17900 = (c["cljsRatom"]);
if((G__17898_17900 == null)){
} else {
reagent.ratom.dispose_BANG_(G__17898_17900);
}
...
if(cljs.core.truth_((function (){var and__8510__auto__ = wrap;
if(cljs.core.truth_(and__8510__auto__)){
return f;
} else {
...
var renders_17902 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_17903 = cljs.core.first(cljs.core.vals(renders_17902));
if((cljs.core.count(renders_17902) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_17902))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_17903)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_17903], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__8522__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8522__auto__)){
return or__8522__auto__;
} else {
...
var render_fun__$1 = (function (){var or__8522__auto__ = render_fun;
if(cljs.core.truth_(or__8522__auto__)){
return or__8522__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__8522__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8522__auto__)){
return or__8522__auto__;
} else {
...
var name__$1 = (function (){var G__17901 = name;
switch (G__17901) {
case "":
...
var G__17906 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__17906) : reagent.impl.component.global$module$create_react_class.call(null,G__17906));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__17907 = fiber;
var G__17907__$1 = (((G__17907 == null))?null:(G__17907["type"]));
if((G__17907__$1 == null)){
return null;
} else {
return (G__17907__$1["displayName"]);
}
})();
var parent = (function (){var G__17908 = fiber;
if((G__17908 == null)){
return null;
} else {
return (G__17908["return"]);
}
})();
var path = (function (){var G__17909 = parent;
var G__17909__$1 = (((G__17909 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__17909) : reagent.impl.component.fiber_component_path.call(null,G__17909)));
if((G__17909__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17909__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__8522__auto__ = (function (){var G__17911 = c;
if((G__17911 == null)){
return null;
} else {
return (G__17911["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__8522__auto__)){
return or__8522__auto__;
...
return G__17912._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__8522__auto__ = (function (){var G__17914 = c;
if((G__17914 == null)){
return null;
} else {
return (G__17914["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__8522__auto__)){
return or__8522__auto__;
} else {
var or__8522__auto____$1 = (function (){var G__17916 = c;
if((G__17916 == null)){
return null;
} else {
return G__17916._reactInternalInstance;
}
})();
...
var elem = (function (){var or__8522__auto__ = (function (){var G__17918 = instance;
if((G__17918 == null)){
return null;
} else {
return (G__17918["_currentElement"]);
}
})();
if(cljs.core.truth_(or__8522__auto__)){
return or__8522__auto__;
} else {
var G__17919 = instance;
if((G__17919 == null)){
return null;
} else {
return G__17919._currentElement;
}
}
})();
var name = (function (){var G__17920 = elem;
var G__17920__$1 = (((G__17920 == null))?null:(G__17920["type"]));
if((G__17920__$1 == null)){
return null;
} else {
return (G__17920__$1["displayName"]);
}
})();
var owner = (function (){var or__8522__auto__ = (function (){var G__17922 = elem;
if((G__17922 == null)){
return null;
} else {
return (G__17922["_owner"]);
}
})();
if(cljs.core.truth_(or__8522__auto__)){
return or__8522__auto__;
...
return G__17923._owner;
}
}
})();
var path = (function (){var G__17924 = owner;
var G__17924__$1 = (((G__17924 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__17924) : reagent.impl.component.component_path.call(null,G__17924)));
if((G__17924__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17924__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var n = (function (){var or__8522__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__8522__auto__)){
return or__8522__auto__;
} else {
var G__17925 = c;
var G__17925__$1 = (((G__17925 == null))?null:G__17925.constructor);
if((G__17925__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__17925__$1);
}
}
})();
