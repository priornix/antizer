...
The following are examples of how Antizer is implemented in the supported ClojureScript React libraries.

* Reagent Example  
* Rum Example

The API documentation can be found here: http://priornix.github.io/antizer/api/latest.html
